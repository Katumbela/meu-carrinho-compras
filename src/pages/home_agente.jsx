        ...
        try {
            ...
            if (querySnapshot.empty) {
                ...
                querySnapshot.forEach(async (doc) => {
                    ...
                    let textoo2 = `Caríssimo/a ${pedidos.nome2},o artigo que lhe foi enviado(${pedidos.artigo}) pelo/a Sr(a). ${pedidos.nome} 📦✅  chegou ao destino de entrega [${pedidos.endereco2}] 🏠 que é supostamente o seu endereço, o Agente ${use.name.split(" ")[0]} está aguardando pela recepção 👀👌📦🧾\n\n Veja aqui: ${linkk}\n\n\nTotal: **${pedidos.taxa} 💵 Kz**  \n\n Avalie nos na plataforma, como foi sua experiência **Atenciosamente, Meu Carrinho LTDA.**`;
